...
class BadRequestFoutbericht(BaseModel):
    ...
    invalid_params: Optional[List[InvalidParam]] = Field(default=None, description="Foutmelding per fout in een parameter. Alle gevonden fouten worden één keer teruggemeld. ", alias="invalidParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "invalidParams": [InvalidParam.from_dict(_item) for _item in obj["invalidParams"]] if obj.get("invalidParams") is not None else None
        })
        return _obj
